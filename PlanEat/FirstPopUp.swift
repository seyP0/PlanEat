    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 16) {
                ...
                HStack(spacing: 16) {
                    MoodFaceButton1(name: "Happy", imageName: "smile", selectedImageName: "smileFaded", isSelected: selectedMoodFace == "Happy") {
                        selectedMoodFace = "Happy"
                    }
                    MoodFaceButton1(name: "Neutral", imageName: "neutral", selectedImageName: "neutralFaded", isSelected: selectedMoodFace == "Neutral") {
                        selectedMoodFace = "Neutral"
                    }
                    MoodFaceButton1(name: "Sad", imageName: "sad", selectedImageName: "sadFaded", isSelected: selectedMoodFace == "Sad") {
                        selectedMoodFace = "Sad"
                    }
                    MoodFaceButton1(name: "Angry", imageName: "angry", selectedImageName: "angryFaded", isSelected: selectedMoodFace == "Angry") {
