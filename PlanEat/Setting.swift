...
/// A pill-style button that shows an outline when inactive and a filled background when selected.
struct PillButtonStyle: ButtonStyle {
    ...
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            ...
            .foregroundColor(isSelected ? .white : Color(red: 0.43, green: 0.57, blue: 0.65))
            .overlay(
